...
svm_model = joblib.load("Supervised/svm_model.pkl")

# Load skill vocabulary
def load_skill_list(file="datasets/unique_skills.txt"):
...
# If user selected a target role, show learning suggestions
            if target_role != "None":
                    ...
                    @st.cache_data
                    def load_resources():
                        return pd.read_csv("datasets/learning_resources_dataset.csv")
