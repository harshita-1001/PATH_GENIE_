...
# ...existing code...
vectorizer = joblib.load("Unsupervised/skill_vectorizer.pkl")
kmeans = joblib.load("Unsupervised/skill_kmeans_model.pkl")
cluster_labels = joblib.load("Unsupervised/cluster_labels.pkl")  # dict: cluster_id → domain
# ...existing code...  # dict: cluster_id → domain
